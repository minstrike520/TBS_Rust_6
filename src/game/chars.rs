pub struct Attribute {
    pub base: i32,
    multiplier_percentage: f32,
    addend: i32,
}
impl Attribute {
    fn new(base: i32) -> Self {
        Self { base, multiplier_percentage: 0.0, addend: 0 }
    }
    pub fn get(&self) -> i32 {
        (self.base as f32 * (1.0 + self.multiplier_percentage) + self.addend as f32 + 0.5).floor() as i32
    }
}
